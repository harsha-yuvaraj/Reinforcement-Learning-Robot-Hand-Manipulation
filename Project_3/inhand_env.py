...
class CanRotateEnv(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        self.action_space = spaces.Box(low=-0.2, high=0.2, shape=(16,), dtype=np.float32)
    ...
    def _calculate_reward(self):
        ...
        rotation_reward = angular_velocity_z * 50.0
        ...
        return rotation_reward + survival_reward + contact_reward
    ...
    def reset(self, seed=None, options=None):
        ...
        if self.render_mode != "headless": self.viewer.sync()
